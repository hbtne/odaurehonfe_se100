        ...
        try {
            const response = await axios.get('http://localhost:5278/api/bookticket/search', {
                params: {
                    ...
                    returnDate: checked ? searchParams.returnDate : '',
                    ticketCount: searchParams.ticketCount,
                },
            });
    ...
    onChange={(e) => setSearchParams({ ...searchParams, arrivalPlace: e.target.value })} />
                        ...
                        {checked && (
                            <div className={styles.field}>
                                ...
                                <input type="date" id="returnDate" className={styles.inputField1} value={searchParams.returnDate}
    onChange={(e) => setSearchParams({ ...searchParams, returnDate: e.target.value })} />
                            </div>
                        )}
                        <div className={styles.field}>
                            <label htmlFor="ticketNumber" className={styles.text}>Số vé</label>
                            <input type="number" id="ticketNumber" className={styles.inputField}  value={searchParams.ticketCount}
    onChange={(e) => setSearchParams({ ...searchParams, ticketCount: parseInt(e.target.value, 10) })}/>
                        </div>
                    </div>
                </Box>
